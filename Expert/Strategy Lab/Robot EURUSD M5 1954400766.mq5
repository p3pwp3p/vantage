...
static input int    Magic_Number = 1954400766; // Magic number
...
static input string ___2______   = "------"; // --- Williams' Percent Range ---
       ...
       input double Ind2Param1   =    -71.0; // Level

static input string ___3______   = "------"; // --- Moving Averages Crossover ---
       input int    Ind3Param0   =       13; // Fast MA period
       input int    Ind3Param1   =       44; // Slow MA period

static input string ___4______   = "------"; // --- Envelopes ---
       input int    Ind4Param0   =        3; // Period
       input double Ind4Param1   =     0.64; // Deviation %
...
//+------------------------------------------------------------------+
/*STRATEGY MARKET BlackBull; EURUSD; M5 */
/*STRATEGY CODE {"properties":{"entryLots":0.01,"tradeDirectionMode":0,"oppositeEntrySignal":0,"stopLoss":80,"takeProfit":86,"useStopLoss":true,"useTakeProfit":true,"isTrailingStop":false},"openFilters":[{"name":"Accelerator Oscillator","listIndexes":[6,0,0,0,0],"numValues":[0,0,0,0,0,0]},{"name":"Momentum","listIndexes":[0,3,0,0,0],"numValues":[42,100,0,0,0,0]},{"name":"Williams' Percent Range","listIndexes":[3,0,0,0,0],"numValues":[27,-71,0,0,0,0]},{"name":"Moving Averages Crossover","listIndexes":[3,0,0,0,0],"numValues":[13,44,0,0,0,0]}],"closeFilters":[{"name":"Envelopes","listIndexes":[5,3,0,0,0],"numValues":[3,0.64,0,0,0,0]}]} */
