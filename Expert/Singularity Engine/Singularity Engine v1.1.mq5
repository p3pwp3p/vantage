//+------------------------------------------------------------------+
//|                                  Singularity Engine v1.1.mq5     |
//|                                  Copyright 2025, p3pwp3p         |
//|                                             https://www.mql5.com |
//+------------------------------------------------------------------+
#property copyright "Copyright 2025, p3pwp3p"
#property link "https://www.mql5.com"
#property version "11.1"  // Stealth & Direction Lock
#property strict
...
input string EAComment = "SE v1.1";
...
input int EntryCooldownSeconds = 3600;  // 진입 후 n초 휴식
input double EntryBufferPip = 20.0;     // 돌파 버퍼 (pip)
