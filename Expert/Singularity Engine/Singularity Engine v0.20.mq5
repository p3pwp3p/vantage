...
class CSingularityEngine {
  ...
  public:
    ...
    bool init(ulong magic, double lot, int bPeriod, double bDev, double bwThreshold, int slPoints, int tpPoints, int adxPeriod);
...
bool CSingularityEngine::init(ulong magic, double lot, int bPeriod, double bDev, double bwThreshold, int slPoints,
                              int tpPoints, int aPeriod) {
...
int OnInit() {
    ...
    if (!GEngine.init(MagicNumber, LotSize, BandsPeriod, BandsDeviation, BandwidthThreshold, StopLossPoints,
                     TakeProfitPoints, AdxPeriod)) {
